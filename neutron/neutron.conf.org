...
# Warning: This feature is experimental with low test coverage, and the Dibbler
# client which is used for this feature is no longer maintained! Enables IPv6
# Prefix Delegation for automatic subnet CIDR allocation. Set to True to enable
# IPv6 Prefix Delegation for subnet allocation in a PD-capable environment.
# Users making subnet creation requests for IPv6 subnets without providing a
# CIDR or subnetpool ID will be given a CIDR via the Prefix Delegation
# mechanism. Note that enabling PD will override the behavior of the default
# IPv6 subnetpool. (boolean value)
...
# Number of resources for neutron to divide the large RPC call data sets. It
# can be reduced if RPC timeout occurred. The best value can be determined
...
# DEPRECATED: Username for connecting to designate in admin context (string
# value)
...
# DEPRECATED: Password for connecting to designate in admin context (string
# value)
# This option is deprecated for removal since Xena.
# Its value may be silently ignored in the future.
# Reason: This option will be completely replaced by keystoneauth parameters.
...
# DEPRECATED: Tenant id for connecting to designate in admin context (string
# value)
# This option is deprecated for removal since Xena.
# Its value may be silently ignored in the future.
# Reason: This option will be completely replaced by keystoneauth parameters.
...
# DEPRECATED: Tenant name for connecting to designate in admin context (string
# value)
# This option is deprecated for removal since Xena.
# Its value may be silently ignored in the future.
# Reason: This option will be completely replaced by keystoneauth parameters.
...
# DEPRECATED: Authorization URL for connecting to designate in admin context
# (string value)
# This option is deprecated for removal since Xena.
# Its value may be silently ignored in the future.
# Reason: This option will be completely replaced by keystoneauth parameters.
...
# consequence, range of values is 8, 16 and 24 (integer value)
...
# a consequence, range of values is 4, 8, 12, 16,..., 124 (integer value)
